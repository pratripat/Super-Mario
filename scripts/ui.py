...
class UI:
    ...
    def render(self):
        ...
        level, self.world_type, self.cutscene_path = json.load(open('data/levels/level_order.json', 'r'))[self.game.level]
        ...
        time_counter_surface = self.game.font.get_surface(str(int(self.time)))
        ...
        self.game.font.render(self.game.screen, str(int(self.time)), [position3[0]+time_surface.get_width()-time_counter_surface.get_width(), 50], scale=3)
